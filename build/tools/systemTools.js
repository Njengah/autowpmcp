...
export function registerSystemTools(server) {
    ...
    server.tool("get-site-health", "Check WordPress core health status and identify errors", {
    ...
    server.tool("check-core-updates", "Check for available WordPress core updates", {
    ...
    server.tool("apply-core-update", "Install available WordPress core updates", {
    ...
    server.tool("scan-for-malware", "Scan WordPress site for malware and security threats", {
    ...
    // Lock Site Tool
    server.tool("lock-site", "Enable maintenance mode to lock the site", {
    ...
    // Unlock Site Tool
    server.tool("unlock-site", "Disable maintenance mode to unlock the site", {}, async () => {
        try {
    ...
    // Clear Cache Tool
    server.tool("clear-cache", "Purge various WordPress caches", {
    ...
    server.tool("backup-database", "Create a database backup (requires compatible backup plugin)", {
    ...
    server.tool("get-system-info", "Get comprehensive WordPress system information", {
